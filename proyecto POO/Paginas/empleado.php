<?php
 ...
 $empleado = empleado::recuperarTodos();
?>
<!DOCTYPE html>
<html>
   <head>
    ...
    <div class="container text-center bg-light-subtle border border-dark-subtle rounded-3" id="empleados">
      <br>
        ...
        <div class="col-md-3">  
         ...
         <div class="col-md-3">  
            <a href="../formularios/formularioEmpleado.html">
        ...
        <tbody>
         <?php foreach($empleado as $item): ?>
            ...
            <td> <?php echo $item['horarioEntrada']; ?> </td>
            <td> <?php echo $item['horarioSalida']; ?> </td>
            <td> <?php echo $item['estacionamiento']; ?> </td>
            <td><a href="../formularios/actualizaEmpleado.php?id=<?php echo $item['id']?>">
            <button type="submit" class="btn btn-outline-info btn-sm">editar</button></a>
            <a href="../queries/eliminarEmpleado.php?id=<?php echo $item['id']?>">
