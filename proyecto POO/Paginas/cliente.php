    ...
    <div class="container text-center bg-light-subtle border border-dark-subtle rounded-3" id="empleados">
      <br>
        ...
        <div class="col-md-3">  
         ...
         <div class="col-md-3">  
            <a href="../formularios/formularioUsuario.html">
        ...
        <tbody>
         <?php foreach($cliente as $item): ?>
            ...
            <td><a href="../formularios/actualizaCliente.php?id=<?php echo $item['id']?>">
            <button type="submit" class="btn btn-outline-info btn-sm">editar</button></a>
            <a href="../queries/eliminarCliente.php?id=<?php echo $item['id']?>">
